# -*- coding: utf-8 -*-
"""4_Despliegue_ValidacionCruz_Clasif.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1xAX1t-5QdUDPgvEuYnL_nqR_-ElGqIOr
...
st.markdown("""
    ...
    .panel {
        ...
        padding:1.2rem 1.4rem; box-shadow:0 1px 3px rgba(18,35,63,.06);
    }
...
with tab_resultado:
    ...
    with col_izq:
        ...
        if not evaluar:
            st.markdown("**Sin evaluación todavía.** Captura la ficha en el panel izquierdo "
                        "y pulsa *Evaluar paciente* para obtener la predicción.")
        else:
            # Predicción con el Random Forest
            ...
            riesgo_alto = Y_pred_etiqueta[0] == 'Yes'
    ...
    with col_der:
        ...
        m1, m2 = st.columns(2)
        m1.metric("Edad", f"{int(age)}")
        m2.metric("Glucosa", f"{avg_glucose_level:.1f}")
        st.write(
...
with tab_modelo:
    ...
    st.info("El modelo tiene un error del 8% (mape: error porcentual). "
